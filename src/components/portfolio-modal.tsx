        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            {project.services.map((service) => (
              <span
                key={service}
                className="inline-block px-3 py-1 text-xs font-medium text-[#C8C8C0] border border-[#242424] rounded-full bg-[#0D0D0D] font-sans"
              >
                {service}
              </span>
            ))}
          ...
          <div className="bg-cd-gold/5 border border-cd-gold/20 rounded-lg px-4 py-3">
            <span className="text-xs text-[#C8C8C0] font-sans uppercase tracking-wider">
              Key Result
            </span>
