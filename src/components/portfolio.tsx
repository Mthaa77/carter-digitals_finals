      ...
      <section id="portfolio" className="py-20 md:py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="mt-5 text-[#888880] text-lg max-w-xl mx-auto font-sans">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.services.map((service) => (
                      <span
                        key={service}
                        className="inline-block px-2.5 py-0.5 text-xs font-medium text-[#888880] border border-[#242424] rounded-full bg-[#111111] font-sans"
                      >
                        {service}
                      </span>
                    ))}
                  ...
                  {/* Description */}
                  <p className="text-[#888880] text-sm leading-relaxed mb-4 font-sans">
                    {project.description}
                  </p>
                  ...
                  {!project.isComingSoon && (
                    <button
                      ...
                      className="inline-flex items-center text-sm font-medium text-[#888880] hover:text-[#C9A84C] transition-colors duration-200 font-sans group/link"
                    >
                      View Case Study
