...
import { ArrowLeft, Globe, LayoutDashboard, TrendingUp, CheckCircle, Layers, Clock } from 'lucide-react'
...
const howItWorks = [
  {
    ...
    description: 'Choose between SME Website, Dashboard, or SEO & Growth. Each has its own base price and feature set.',
    color: 'text-cd-gold',
  ...
  },
  {
    ...
    description: 'Toggle the features you need — responsive design, CMS, e-commerce, analytics, and more.',
  ...
  },
  {
    ...
    description: 'See a price range and estimated timeline instantly. No commitment, no email required.',
    color: 'text-cd-cyan',
...
const whyUseThisTool = [
  {
    ...
    description: 'Our 3-step wizard makes estimating your project easy and intuitive. No technical knowledge needed.',
    color: 'text-cd-gold',
  },
  {
    icon: TrendingUp,
    title: 'Multiple Service Types',
    description: 'SME websites, dashboards, and SEO — get estimates for any digital service you need.',
    color: 'text-cd-emerald',
  },
  {
    icon: Layers,
    title: 'Feature-Based Pricing',
    description: 'See exactly how each feature affects the price. Full transparency, no hidden costs.',
    color: 'text-cd-cyan',
  },
  {
    icon: CheckCircle,
    title: 'Timeline Included',
    description: 'Not just price — get an estimated delivery timeline based on your selected features.',
      ...
      <main id="main-content" className="min-h-screen flex flex-col bg-[#080808]">
        ...
        <section className="aurora-bg relative pt-32 pb-20 md:pt-44 md:pb-28 overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <motion.div
              className="absolute w-[500px] h-[500px] rounded-full bg-[#22D3EE] blur-[160px] opacity-[0.06]"
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[rgba(34,211,238,0.1)] border border-[rgba(34,211,238,0.2)] mb-6"
            >
              <Layers className="w-8 h-8 text-cd-cyan" />
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-cd-cyan heading-shadow-lg font-display font-bold leading-tight mb-5"
        ...
        <section className="relative py-20 md:py-28 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute bottom-0 left-0 w-[500px] h-[400px] rounded-full bg-[#22D3EE] blur-[180px] opacity-[0.03]" />
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2
                className="text-cd-cyan heading-shadow font-display font-bold leading-tight mb-3"
                style={{ fontSize: 'var(--text-h2)' }}
              >
                3 Simple Steps
              </h2>
              <p className="text-[var(--cd-text-muted)] text-lg max-w-xl mx-auto">
                Get your project estimate in under a minute.
              </p>
            </motion.div>
        ...
        <section className="aurora-bg relative py-20 md:py-28 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-[var(--cd-text-muted)] text-lg max-w-xl mx-auto">
                Plan your digital project with confidence.
              </p>
            </motion.div>
        ...
        <section className="relative py-20 md:py-28 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full bg-[#22D3EE] blur-[180px] opacity-[0.06]" />
          </div>
          <div className="absolute top-0 left-0 right-0 neon-line opacity-40" />
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-[var(--cd-text-muted)] text-lg md:text-xl max-w-xl mx-auto mb-10">
                Turn your estimate into reality. Let&apos;s build exactly what you need, on time and on budget.
              </p>
