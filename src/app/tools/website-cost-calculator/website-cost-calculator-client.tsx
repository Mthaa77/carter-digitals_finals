...
import { ArrowLeft, Calculator, FileText, Sparkles, Clock, CheckCircle, Zap, Shield } from 'lucide-react'
...
const howItWorks = [
  {
    ...
    description: 'Slide to choose how many pages your website needs. The first 4 are included in the base price.',
    color: 'text-cd-gold',
  ...
  },
  {
    ...
    description: 'Select the features you need — blog, e-commerce, booking system, and more. Each adds transparently to your estimate.',
  ...
  },
  {
    ...
    description: 'Urgent, standard, or flexible? Your timeline affects the price, and we show you exactly how.',
    color: 'text-cd-cyan',
...
const whyUseThisTool = [
  {
    ...
    description: 'Get a price range in seconds. No hidden fees, no "contact us for pricing" games.',
    color: 'text-cd-gold',
  },
  {
    icon: Shield,
    title: 'Based on Real Packages',
    description: 'Our estimates are tied to real Vula, Khula, and Elevate packages — not arbitrary numbers.',
    color: 'text-cd-emerald',
  },
  {
    icon: Zap,
    title: 'No Email Required',
    description: 'Use the tool freely. No sign-up, no spam, no follow-up calls. Just useful numbers.',
    color: 'text-cd-cyan',
  },
  {
    icon: CheckCircle,
    title: 'South African Context',
    description: 'Prices in Rands, built for Pretoria and Gauteng businesses. Includes B-BBEE benefits.',
    color: 'text-cd-violet',
  },
]

export default function WebsiteCostCalculatorClient() {
  return (
    <>
      <Navigation />
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-[var(--cd-text-muted)] text-lg max-w-xl mx-auto">
                Get your estimate in under a minute. No commitment needed.
              </p>
            </motion.div>
        ...
        <section className="aurora-bg relative py-20 md:py-28 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-[var(--cd-text-muted)] text-lg max-w-xl mx-auto">
                Built for South African business owners who want honest pricing.
              </p>
            </motion.div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-[var(--cd-text-muted)] text-lg md:text-xl max-w-xl mx-auto mb-10">
                Get an exact quote tailored to your business. No hidden costs, no surprises — just real results.
              </p>
